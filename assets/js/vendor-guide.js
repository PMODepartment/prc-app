...
(function () {
  var SLIDES = [
    ...
    { icon: 'ti-user-plus', title: 'Adding vendors', body:
      '<ul><li><b>Add Vendor</b> — create a vendor you’ve vetted; it goes straight into the directory.</li><li>Print or share the <b>Registration QR code</b> (Data Tools) — one link works for every vendor, or scan a vendor’s own QR (from their profile) to pre-fill their code.</li><li>The older per-vendor <b>Enable self-service</b> / <b>Invite list (CSV)</b> (bulk bar) still works if you’d rather send a mail-merge of individual links.</li></ul>' },
