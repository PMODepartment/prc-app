-- MIGRATION_vendor_rates_wp_link.sql
-- Run once in Supabase SQL Editor. Requires MIGRATION_vendor_management.sql
...
-- "vendor_rates_write" policies (MIGRATION_vendor_management.sql) apply to
